...
Detects the language via ``Cargo.toml`` but raises :class:`NotSupportedError`
for every analysis method. Contributors: copy this file to add real Rust
support. See ``docs/METHODOLOGY.md`` for the contract each method must
satisfy.
"""
